...
mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    const struct Iter iter = {
        .mg = (int32_t)mxGetScalar(prhs[5]),
        .mu = (int32_t)mxGetScalar(prhs[6]),
        .pre = (int32_t)mxGetScalar(prhs[7]),
        .post = (int32_t)mxGetScalar(prhs[8]),
        .bs = (int32_t)mxGetScalar(prhs[9]),
        .l = (int32_t)mxGetScalar(prhs[10]),
